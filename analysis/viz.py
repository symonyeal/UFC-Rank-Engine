...
# ===========================================================================
# Notebook chart additions (2026-06-23) — see _archive/20260901-lean-pass/analysis/CHART_PLAN.md.
...
def integrity_ledger_table(
    ...
    *,
    ...
    A per-fight rating-point debit is deliberately never manufactured here.
    """
    cols = [
...
def integrity_impact_chart(
    ...
    *,
    ...
    base-WHR rating points. If that artifact is absent, old snapshots fall back
    to their recorded result-weight discounts and say so in the chart.
    """
    n = max(1, int(n))
    board_available = (
